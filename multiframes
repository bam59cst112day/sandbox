...
void drawFrame( float headY, float pantsY     ){
 
 noStroke();
 fill(233,203,141);                    //skin color
 rect(manX-5,headY,25,30);           //head
 ...
 quad(manX-10,pantsY, manX-5,pantsY, manX-15,pantsY+15, manX-20,pantsY-5);  //back upper leg
